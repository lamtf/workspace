...
public class GetByRepeatedProductCodeOut {

	public static GetByRepeatedProductCodeOut FromCursor(Cursor cursor){
		GetByRepeatedProductCodeOut instance = new GetByRepeatedProductCodeOut();
