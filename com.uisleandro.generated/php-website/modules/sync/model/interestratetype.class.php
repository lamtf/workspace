...
class InterestRateType {
	...
	public function get_for_client_insert($fk_interest_rate_type, $page_number, $page_size){
		$query = "SELECT \"id\" as \"server_id\", \"last_update\"".
		",\"name\"".
		" FROM \"simpledb\".\"interest_rate_type\"".
		" WHERE \"id\" > ". \db::number($fk_interest_rate_type).
	...
	public function insert($last_update,$name){
		...
		$query = "INSERT INTO \"simpledb\".\"interest_rate_type\"(".
		"\"last_update\"".
		",\"name\"".") VALUES (".
		...
		$this->db->query($query);
		$query = "SELECT currval(pg_get_serial_sequence('simpledb.interest_rate_type','id'));";
		$stmt = $this->db->query($query);
	...
	public function update($id, $last_update,$name){
		...
		$query = "UPDATE \"simpledb\".\"interest_rate_type\" SET ".
	...
	function get_for_client_update($last_update_time, $page_number, $page_size){
		...
		$query = "SELECT \"id\" as \"server_id\", \"last_update\", \"name\" FROM \"simpledb\".\"interest_rate_type\" WHERE last_update_time > " . $last_update_time;
