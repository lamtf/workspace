...
class ProductOnSale {
	...
	public function get_for_client_insert($fk_product_on_sale, $page_number, $page_size){
		$query = "SELECT \"id\" as \"server_id\", \"last_update\"".
		",\"fk_sale\"".
		",\"fk_product\"".
		" FROM \"simpledb\".\"product_on_sale\"".
		" WHERE \"id\" > ". \db::number($fk_product_on_sale).
	...
	public function insert($last_update,$fk_sale,$fk_product){
		$last_update_time = \db::timestamp();

		$query = "INSERT INTO \"simpledb\".\"product_on_sale\"(".
		"\"last_update\"".
		",\"fk_sale\"".
		",\"fk_product\"".") VALUES (".
		...
		$this->db->query($query);
		$query = "SELECT currval(pg_get_serial_sequence('simpledb.product_on_sale','id'));";
		$stmt = $this->db->query($query);
	...
	public function update($id, $last_update,$fk_sale,$fk_product){

		$last_update_time = \db::timestamp();

		$query = "UPDATE \"simpledb\".\"product_on_sale\" SET ".
	...
	function get_for_client_update($last_update_time, $page_number, $page_size){
		...
		$query = "SELECT \"id\" as \"server_id\", \"last_update\", \"fk_sale\", \"fk_product\" FROM \"simpledb\".\"product_on_sale\" WHERE last_update_time > " . $last_update_time;
