...
public class BrazilianDataView {
	...
	public String[] toInsertArray () {
		return new String[]{String.valueOf(last_update), cpf, rg, String.valueOf(fk_basic_client)};
	}

	public String[] toUpdateArray () {
		return new String[]{String.valueOf(id), String.valueOf(server_id), String.valueOf(dirty), String.valueOf(last_update), cpf, rg, String.valueOf(fk_basic_client)};
	}
