...
public class RoleDataView {
	...
	public static RoleDataView FromJson(String json){
		if(json != null) {
			try {
				JSONObject obj = new JSONObject(json);
				return RoleDataView.FromJsonObj(obj);
	...
	public static RoleDataView FromJsonObj(JSONObject obj) {
		if(null != obj) {
			try {
				RoleDataView result = new RoleDataView();
	...
	public static RoleDataView FromCursor (Cursor cursor) {
		if(null != cursor){
			RoleDataView result = new RoleDataView();
