...
public class RoleDataView {
	...
	public static RoleView FromJson(String json){
		if(json != null) {
			try {
				JSONObject obj = new JSONObject(json);
				return RoleView.FromJsonObj(obj);
	...
	public static RoleView FromJsonObj (JSONObject obj) {
		if(null != obj) {
			try {
	...
	public static RoleView FromCursor (Cursor cursor) {
		if(null != cursor){
			RoleView result = new RoleView();
