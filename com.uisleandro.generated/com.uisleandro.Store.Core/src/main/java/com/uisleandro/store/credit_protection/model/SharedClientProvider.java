...
public class SharedClientProvider extends ContentProvider {
	...
	public static final int SHARED_CLIENT_INSERT_NUMBER = 1;
	public static final String SHARED_CLIENT_INSERT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/insert";
	...
	public static final int SHARED_CLIENT_UPDATE_NUMBER = 2;
	public static final String SHARED_CLIENT_UPDATE_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/update";
	...
	public static final int SHARED_CLIENT_DELETE_NUMBER = 3;
	public static final String SHARED_CLIENT_DELETE_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/delete";
	...
	public static final int SHARED_CLIENT_ALL_NUMBER = 4;
	public static final String SHARED_CLIENT_ALL_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/all";
	...
	public static final int SHARED_CLIENT_SOME_NUMBER = 5;
	public static final String SHARED_CLIENT_SOME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/some";
	...
	public static final int SHARED_CLIENT_BY_ID_NUMBER = 6;
	public static final String SHARED_CLIENT_BY_ID_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/by_id";
	public static final String SHARED_CLIENT_BY_ID = SCHEME + AUTHORITY + "/by_id";
	public static final Uri URI_SHARED_CLIENT_BY_ID = Uri.parse(SHARED_CLIENT_BY_ID);
	public static final String SHARED_CLIENT_BY_ID_BASE = SHARED_CLIENT_BY_ID + "/";

	public static final int SHARED_CLIENT_LAST_ID_NUMBER = 7;
	public static final String SHARED_CLIENT_LAST_ID_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/last_id";
	public static final String SHARED_CLIENT_LAST_ID = SCHEME + AUTHORITY + "/last_id";
	public static final Uri URI_SHARED_CLIENT_LAST_ID = Uri.parse(SHARED_CLIENT_LAST_ID);
	public static final String SHARED_CLIENT_LAST_ID_BASE = SHARED_CLIENT_LAST_ID + "/";
...
// Start of user code reserved-for:AndroidSqliteDatabase003
	...
	static {
		MATCHER.addURI(AUTHORITY,"insert", SHARED_CLIENT_INSERT_NUMBER);
		MATCHER.addURI(AUTHORITY,"update", SHARED_CLIENT_UPDATE_NUMBER);
		MATCHER.addURI(AUTHORITY,"delete", SHARED_CLIENT_DELETE_NUMBER);
		MATCHER.addURI(AUTHORITY,"all", SHARED_CLIENT_ALL_NUMBER);
		MATCHER.addURI(AUTHORITY,"some", SHARED_CLIENT_SOME_NUMBER);
		MATCHER.addURI(AUTHORITY,"by_id", SHARED_CLIENT_BY_ID_NUMBER);
		MATCHER.addURI(AUTHORITY,"last_id", SHARED_CLIENT_LAST_ID_NUMBER);
...
// begin content-provider-interface
	...
	public String getType (@NonNull Uri uri) {
		...
		switch (MATCHER.match(uri)){
			case SHARED_CLIENT_INSERT_NUMBER:
				return SHARED_CLIENT_INSERT_TYPE;
			case SHARED_CLIENT_UPDATE_NUMBER:
				return SHARED_CLIENT_UPDATE_TYPE;
			case SHARED_CLIENT_DELETE_NUMBER:
				return SHARED_CLIENT_DELETE_TYPE;
			case SHARED_CLIENT_ALL_NUMBER:
				return SHARED_CLIENT_ALL_TYPE;
			case SHARED_CLIENT_SOME_NUMBER:
				return SHARED_CLIENT_SOME_TYPE;
			case SHARED_CLIENT_BY_ID_NUMBER:
				return SHARED_CLIENT_BY_ID_TYPE;
			case SHARED_CLIENT_LAST_ID_NUMBER:
				return SHARED_CLIENT_LAST_ID_TYPE;
...
// Start of user code reserved-for:AndroidSqliteDatabase010
	...
	public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
		...
		else if (URI_SHARED_CLIENT_BY_ID.equals(uri)) {
			result = getById(Long.parseLong(selectionArgs[0]));
		}
		else if (URI_SHARED_CLIENT_LAST_ID.equals(uri)) {
			result = getLastId();
		}
