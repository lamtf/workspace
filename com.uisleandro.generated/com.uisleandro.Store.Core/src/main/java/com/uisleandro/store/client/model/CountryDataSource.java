...
import com.uisleandro.store.client.view.CountryView;
...
public class CountryDataSource {
	...
	public CountryView cursorToCountryView(Cursor cursor){

	 	CountryView that = new CountryView();
	...
	public List<CountryView> cursorToListOfCountryView(Cursor cursor){

		List<CountryView> those = new ArrayList();

		cursor.moveToFirst();
		while(!cursor.isAfterLast()){
			CountryView that = cursorToCountryView(cursor);
			those.add(that);
			cursor.moveToNext();
		}
		cursor.close();
	...
	public void delete(CountryView that){
		database.delete(DbHelper.TABLE_COUNTRY, DbHelper.COUNTRY_ID + " = " + String.valueOf(that.getId()), null);
	}

	public void deleteById(long id){
		database.delete(DbHelper.TABLE_COUNTRY, DbHelper.COUNTRY_ID + " = " + String.valueOf(id), null);
	}
	...
	public List<CountryView> listAll(){
		...
		return cursorToListOfCountryView(cursor);
	}
