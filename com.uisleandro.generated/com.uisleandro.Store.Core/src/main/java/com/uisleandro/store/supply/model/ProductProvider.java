...
// Start of user code reserved-for:AndroidSqliteQuerySingle002
	public static final int PRODUCT_MISSING_PRODUCTS_RELATORY_NUMBER = 8;
	...
	public static final int PRODUCT_GET_BY_REPEATED_PRODUCT_CODE_NUMBER = 10;
	...
	public static final int PRODUCT_PRODUCT_RECOUNTING_NUMBER = 13;
...
// Start of user code reserved-for:AndroidSqliteQuerySingle006
	...
	public Cursor get_by_id (String[] selectionArgs) {
		//TODO: I might have some data from 'selectionArgs' and also some predefined data
		//TODO: the way it is the transformation is wrong
		String query = "SELECT product.last_update,product.barcode,product.description,product.amount,product.purchase_price,product.sale_price,product.size,product.expiration_date,brand.last_update,brand.company_name,brand.fantasy_name,unit.last_update,unit.name,category.last_update,category.fk_category,category.name,gender.last_update,gender.name,system.last_update,system.name,system.enabled FROM product INNER JOIN system ON product.fk_system = system.id INNER JOIN gender ON product.fk_gender = gender.id INNER JOIN category ON product.fk_category = category.id INNER JOIN unit ON product.fk_unit = unit.id INNER JOIN brand ON product.fk_brand = brand.id WHERE product.id = ?;";
