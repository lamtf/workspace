...
public class TokenDataView {
	...
	public String[] toInsertArray () {
		return new String[]{String.valueOf(last_update), String.valueOf(fk_user), String.valueOf(fk_system), String.valueOf(fk_token_type), guid, String.valueOf(last_use_time), String.valueOf(expiration_time)};
	}

	public String[] toUpdateArray () {
		return new String[]{String.valueOf(id), String.valueOf(server_id), String.valueOf(dirty), String.valueOf(last_update), String.valueOf(fk_user), String.valueOf(fk_system), String.valueOf(fk_token_type), guid, String.valueOf(last_use_time), String.valueOf(expiration_time)};
	}
