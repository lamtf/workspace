...
public class InstallmentTypeProvider extends ContentProvider {
	...
	public static final int INSTALLMENT_TYPE_INSERT_NUMBER = 1;
	public static final String INSTALLMENT_TYPE_INSERT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/insert";
	...
	public static final int INSTALLMENT_TYPE_UPDATE_NUMBER = 2;
	public static final String INSTALLMENT_TYPE_UPDATE_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/update";
	...
	public static final int INSTALLMENT_TYPE_DELETE_NUMBER = 3;
	public static final String INSTALLMENT_TYPE_DELETE_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/delete";
	...
	public static final int INSTALLMENT_TYPE_ALL_NUMBER = 4;
	public static final String INSTALLMENT_TYPE_ALL_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/all";
	...
	public static final int INSTALLMENT_TYPE_SOME_NUMBER = 5;
	public static final String INSTALLMENT_TYPE_SOME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/some";
	...
	public static final int INSTALLMENT_TYPE_BY_ID_NUMBER = 6;
	public static final String INSTALLMENT_TYPE_BY_ID_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/by_id";
	public static final String INSTALLMENT_TYPE_BY_ID = SCHEME + AUTHORITY + "/by_id";
	public static final Uri URI_INSTALLMENT_TYPE_BY_ID = Uri.parse(INSTALLMENT_TYPE_BY_ID);
	public static final String INSTALLMENT_TYPE_BY_ID_BASE = INSTALLMENT_TYPE_BY_ID + "/";

	public static final int INSTALLMENT_TYPE_LAST_ID_NUMBER = 7;
	public static final String INSTALLMENT_TYPE_LAST_ID_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/last_id";
	public static final String INSTALLMENT_TYPE_LAST_ID = SCHEME + AUTHORITY + "/last_id";
	public static final Uri URI_INSTALLMENT_TYPE_LAST_ID = Uri.parse(INSTALLMENT_TYPE_LAST_ID);
	public static final String INSTALLMENT_TYPE_LAST_ID_BASE = INSTALLMENT_TYPE_LAST_ID + "/";
...
// Start of user code reserved-for:AndroidSqliteDatabase003
	...
	static {
		MATCHER.addURI(AUTHORITY,"insert", INSTALLMENT_TYPE_INSERT_NUMBER);
		MATCHER.addURI(AUTHORITY,"update", INSTALLMENT_TYPE_UPDATE_NUMBER);
		MATCHER.addURI(AUTHORITY,"delete", INSTALLMENT_TYPE_DELETE_NUMBER);
		MATCHER.addURI(AUTHORITY,"all", INSTALLMENT_TYPE_ALL_NUMBER);
		MATCHER.addURI(AUTHORITY,"some", INSTALLMENT_TYPE_SOME_NUMBER);
		MATCHER.addURI(AUTHORITY,"by_id", INSTALLMENT_TYPE_BY_ID_NUMBER);
		MATCHER.addURI(AUTHORITY,"last_id", INSTALLMENT_TYPE_LAST_ID_NUMBER);
...
// begin content-provider-interface
	...
	public String getType (@NonNull Uri uri) {
		...
		switch (MATCHER.match(uri)){
			case INSTALLMENT_TYPE_INSERT_NUMBER:
				return INSTALLMENT_TYPE_INSERT_TYPE;
			case INSTALLMENT_TYPE_UPDATE_NUMBER:
				return INSTALLMENT_TYPE_UPDATE_TYPE;
			case INSTALLMENT_TYPE_DELETE_NUMBER:
				return INSTALLMENT_TYPE_DELETE_TYPE;
			case INSTALLMENT_TYPE_ALL_NUMBER:
				return INSTALLMENT_TYPE_ALL_TYPE;
			case INSTALLMENT_TYPE_SOME_NUMBER:
				return INSTALLMENT_TYPE_SOME_TYPE;
			case INSTALLMENT_TYPE_BY_ID_NUMBER:
				return INSTALLMENT_TYPE_BY_ID_TYPE;
			case INSTALLMENT_TYPE_LAST_ID_NUMBER:
				return INSTALLMENT_TYPE_LAST_ID_TYPE;
...
// Start of user code reserved-for:AndroidSqliteDatabase010
	...
	public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
		...
		else if (URI_INSTALLMENT_TYPE_BY_ID.equals(uri)) {
			result = getById(Long.parseLong(selectionArgs[0]));
		}
		else if (URI_INSTALLMENT_TYPE_LAST_ID.equals(uri)) {
			result = getLastId();
		}
