...
public class TokenProvider extends ContentProvider {
	...
	public static final Uri URI_TOKEN_LASTID = Uri.parse(TOKEN_LASTID);
	public static final String TOKEN_LASTID_BASE = TOKEN_LASTID + "/";
...
// Start of user code reserved-for:AndroidSqliteDatabase010
	...
	public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
		...
		else if(URI_TOKEN_LASTID.equals(uri)) {
			result = getLastId();
		}
