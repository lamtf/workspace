...
public class RoleDataSource extends ContentProvider {
	...
	public long delete(RoleView that){
		return database.delete(DbHelper.TABLE_ROLE, DbHelper.ROLE_ID + " = " + String.valueOf(that.getId()), null);
	}

	public long deleteById(long id){
		return database.delete(DbHelper.TABLE_ROLE, DbHelper.ROLE_ID + " = " + String.valueOf(id), null);
	}
