...
public class SystemProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.spaceforsales.system";
...
// begin content-provider-interface
	...
	public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
		int rows_affected = database.update(DbHelper.TABLE_SYSTEM, values, DbHelper.SYSTEM_ID + " = " + selectionArgs[0], null);
		return rows_affected;
	}

	@Override
	public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
		int rows_affected = database.delete(DbHelper.TABLE_SYSTEM, DbHelper.SYSTEM_ID + " = " + selectionArgs[0], null);
		return rows_affected;
	}
