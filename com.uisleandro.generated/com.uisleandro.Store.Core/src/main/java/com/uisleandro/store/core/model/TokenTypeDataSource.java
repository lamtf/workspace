...
public class TokenTypeDataSource extends ContentProvider {
	...
	public long delete(TokenTypeView that){
		return database.delete(DbHelper.TABLE_TOKEN_TYPE, DbHelper.TOKEN_TYPE_ID + " = " + String.valueOf(that.getId()), null);
	}

	public long deleteById(long id){
		return database.delete(DbHelper.TABLE_TOKEN_TYPE, DbHelper.TOKEN_TYPE_ID + " = " + String.valueOf(id), null);
	}
