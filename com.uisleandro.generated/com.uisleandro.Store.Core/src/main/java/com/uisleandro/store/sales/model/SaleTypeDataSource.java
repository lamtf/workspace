...
public class SaleTypeDataSource extends ContentProvider {
	...
	public long delete(SaleTypeView that){
		return database.delete(DbHelper.TABLE_SALE_TYPE, DbHelper.SALE_TYPE_ID + " = " + String.valueOf(that.getId()), null);
	}

	public long deleteById(long id){
		return database.delete(DbHelper.TABLE_SALE_TYPE, DbHelper.SALE_TYPE_ID + " = " + String.valueOf(id), null);
	}
