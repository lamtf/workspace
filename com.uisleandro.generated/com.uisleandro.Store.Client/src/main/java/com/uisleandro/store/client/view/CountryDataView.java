...
public class CountryDataView {
	...
	public static CountryView FromJson(String json){
		if(json != null) {
			try {
				JSONObject obj = new JSONObject(json);
				return CountryView.FromJsonObj(obj);
	...
	public static CountryView FromJsonObj (JSONObject obj) {
		if(null != obj) {
			try {
	...
	public static CountryView FromCursor (Cursor cursor) {
		if(null != cursor){
			CountryView result = new CountryView();
